...
async function getTableById(datasetId) {
  ...
  return {
    dataset: {
      ...
      description:       dataset.meta_description,
      last_updated_date: dataset.last_updated_date,
      future_release:    dataset.future_release,
      key_statistics:    dataset.key_statistics,
